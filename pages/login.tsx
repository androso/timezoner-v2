...
export default function login() {
	return (
		<div className="h-full flex flex-col items-center mx-auto w-[85%]">
			...
			<div className="auth-container mt-16 bg-containerGray py-16 min-w-full px-16 rounded-lg relative text-center drop-shadow-2xl">
...
function LoginButton({ children }: any) {
	return (
		<button className="py-4 px-8 flex items-center bg-gradient-to-t from-btnGradientBott to-btnGradientTop rounded-md mb-2 last:mb-0 drop-shadow-md">
			{children}
		</button>
	);
}
